    ...
    <svg viewBox="0 0 300 300" fill="none" {...props}>
      <g transform="translate(30 0)">
        <path
          ...
          fill="var(--provider-opencode-logo-inner)"
        />
        <path
          d="M180 60H60V240H180V60ZM240 300H0V0H240V300Z"
          fill="var(--provider-opencode-logo-fill)"
        />
      </g>
    </svg>
  );
...
const PROVIDER_BRANDS: Record<string, ProviderBrandMeta> = {
  'claude-code': {
    ...
    tone: {
      avatarBg: '#D97757',
      avatarFg: '#FAF9F5',
      softBg: 'rgba(217, 119, 87, 0.12)',
      softBorder: 'rgba(217, 119, 87, 0.24)',
      icon: '#D97757',
    },
    Icon: ClaudeLogo,
  },
  codex: {
    ...
    displayName: 'Codex',
    tone: {
      avatarBg: 'var(--provider-codex-avatar-bg)',
      avatarFg: 'var(--provider-codex-avatar-fg)',
      softBg: 'var(--provider-codex-soft-bg)',
      softBorder: 'var(--provider-codex-soft-border)',
      icon: 'var(--provider-codex-icon)',
    },
    Icon: CodexLogo,
  },
  opencode: {
    ...
    tone: {
      avatarBg: 'var(--provider-opencode-avatar-bg)',
      avatarFg: 'var(--provider-opencode-avatar-fg)',
      softBg: 'var(--provider-opencode-soft-bg)',
      softBorder: 'var(--provider-opencode-soft-border)',
    ...
    <span
      ...
      style={
        isCodex
          ? style
          : {
              backgroundColor: brand.tone.avatarBg,
              color: brand.tone.avatarFg,
              ...style,
            }
      }
    >
